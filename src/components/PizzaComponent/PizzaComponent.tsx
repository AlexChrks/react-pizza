...
const PizzaComponent: React.FC<IpizzaProps> = ({id, imgSrc, startPrice, name, availableSizes, availableBase }) => {
  ...
  return (
    <div className={styles.card}>
      ...
      <div className={styles.cardFooter}>
        <div className={styles.price}>from {startPrice}BYN</div>
        <button className={styles.toCartButton} onClick={addToCartHandler}>To cart</button>
      </div>
